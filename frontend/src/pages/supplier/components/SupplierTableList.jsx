...
const SupplierTableList = ({ suppliers = [], loading, onSuccess }) => {
            ...
            <Table className="w-full border-b">
              ...
              <TableBody className="bg-card">
                {paginatedData.map((data) => (
                  <TableRow key={data.supplierID} className="h-[61.5px]">
                    ...
                    <TableCell className="text-right">
                      <div className="flex items-center justify-end gap-2">
                        <EditDialog supplier={data} onSuccess={onSuccess} />
...
export default SupplierTableList;
