ALUMINUM AND GLASS SUPPLY SALES AND ORDER MANAGEMENT SYSTEM
...
measurements), purchases materials from hardware suppliers, and delivers and installs the finished
products.

Currently, the business uses a manual system in recording orders, measurements, and product details.
This results in several problems such as incorrect product measurement, wrong items being delivered or
installed, and missing materials during installation. These issues often lead to delays, additional costs,
and customer dissatisfaction.

To address these problems, the proposed system will digitize the sales and ordering process. It will allow
accurate recording of customer orders, including product specifications and measurements, and ensure
that all required materials are listed and tracked. The system will also help verify orders before delivery
and installation, reducing errors and improving overall efficiency.
...
-Manages customer orders from placement to completion. 

-Provides options for Auto and Manual Material Generation based on the selected product. 

-Tracks installation progress in real time. 

-Monitors sales and generates reports. 

-Maintains material and supplier references. 

-Supports Dark Mode and Light Mode for better user. Experience. 
...
STEP 3: Choose Auto/Manual 

STEP 4: Review/Click Ready for Installation 

STEP 5: Process Installation 

STEP 6: Click as Complete 

STEP 7: View Sales/Reports 
